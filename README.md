...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p fe502573-1f0e-4113-b4e1-2b5bec465808
```

> `fe502573-1f0e-4113-b4e1-2b5bec465808` is the password of the certificate, you can change it to any password you want.
